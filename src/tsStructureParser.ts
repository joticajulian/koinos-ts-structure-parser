...
import {TypeModel} from "ts-structure-model";
import {TypeKind} from "ts-structure-model";
import {ArrayType} from "ts-structure-model";
...
import {BasicType} from "ts-structure-model";
import {classDecl} from "ts-structure-model";
